...
battles.map((battle) => {
  attacker_king.push(battle.attacker_king);
  defender_king.push(battle.defender_king);
  region.push(battle.region);
  names.push(battle.name);
  if (!battle_type.includes(battle.battle_type) && battle.battle_type != "") {
    battle_type.push(battle.battle_type);
  }

  if (battle.attacker_outcome == "win") {
    attacker_outcome.win = attacker_outcome.win + 1;
  } else {
    attacker_outcome.loss = attacker_outcome.loss + 1;
  }
